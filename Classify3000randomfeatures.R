...
for (start_index in seq(30001, total_features, by = chunk_size)) {
  ...
  save_objects(results, fold_number = start_index, path_prefix = "/hpc/hers_en/rballieux/AlzheimersProofConcept/Classifiers/Baseline/3000randomfeatures/")
...
write.csv(all_results, "/hpc/hers_en/rballieux/AlzheimersProofConcept/Classifiers/Baseline/3000randomfeatures/ClassifierResults3000randomfeats.csv", row.names = FALSE)